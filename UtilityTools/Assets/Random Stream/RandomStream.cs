...
namespace Utility.Random
{
	...
	public class RandomStream
	{
		...
		{
			//Pega um valor aleat�rio de uma distribui��o normal
			float rand = standardNormalDistribuitionNumber();
			rand = Mathf.Clamp(rand, -1f, 1f);
			//Transforma a distribui��o criada: valor original vem com a m�dia posicinada em 0, e desvio padr�o de 1
			//Reposicina a "m�dia" para a m�dia escolhida (mean) e 
			//escala o desvio padr�o (1) com o valor desejado (sigma)
			rand = (rand * sigma) + mean;
			//Retorna o valor sorteado e transformado de uma "curva do sino"
			return rand;
		}
